...
class PdfEditActivity : AppCompatActivity() {
    ...
    private fun updatePdf() {
        ...
        // Setup data to update to database (spellings of keys must be the same as in Firebase)
    ...
    private fun categoryDialog() {
        /*Show dialog to pick category of pdf/book. we already got the categories*/
    ...
    private fun loadCategories() {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                // Clear lists before starting adding data into them
